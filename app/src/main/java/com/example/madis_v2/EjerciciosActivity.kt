...
class EjerciciosActivity : AppCompatActivity() {
    ...
    var txtTiempo:Chronometer?=null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txtTiempo=findViewById(R.id.simpleChronometer)
    ...
    fun ejerciciosDB() {
        var limite: Float? = null
        var base = 2.toFloat()

        limite = base.pow(nivel)+1
        ejercicios[0] = (Math.random() * limite).toInt().toString()  //{Decimal,resp1,resp2,respuesta}

        ejercicios[3] = obtenerBinario(ejercicios[0]!!.toInt())
        ejercicios[1] = obtenerBinario((Math.random() * limite).toInt())
        ejercicios[2] = obtenerBinario((Math.random() * limite).toInt())
    }
    ...
    fun ejerciciosBD(){
        ...
        ejercicios[3] = (Math.random() * limite).toInt().toString()

        ejercicios[0] = obtenerBinario(ejercicios[3]!!.toInt())
        ejercicios[1] = (Math.random() * limite).toInt().toString()
        ejercicios[2] = (Math.random() * limite).toInt().toString()
    }
